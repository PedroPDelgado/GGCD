...
public class Genre_FilmCount {
    ...
    public static class Genre_FilmCountReducer extends Reducer<Text, LongWritable, Text, Text> {
        @Override
    ...
    public static void main(String[] args) throws Exception {
        ...
        job.setJarByClass(Genre_FilmCount.class);
        ...
        TextOutputFormat.setOutputPath(job, new Path("result"));
